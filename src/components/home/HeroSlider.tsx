...
const slides: Slide[] = [
    {
        ...
        subtitle: 'OEM-quality replacement parts, performance upgrades & accessories. Free shipping on orders over $49.',
        cta: 'Shop Replacement Parts',
        ctaLink: '/shop/replacement-parts',
        bgImage: '/images/categories/replacement-parts.jpg',
        bgColor: 'from-zinc-900/85 via-zinc-800/75 to-slate-900/85',
        badge: '🔧 Best Sellers',
    },
    {
        title: 'Upgrade Your',
        highlight: 'Truck & Off-Road',
        subtitle: 'Tonneau covers, running boards, locking hubs & towing gear built for tough conditions.',
        cta: 'Shop Truck Parts',
        ctaLink: '/shop/truck-parts-accessories',
        bgImage: '/images/categories/truck-parts-accessories.jpg',
    ...
    },
    {
        ...
        subtitle: 'Ceramic coatings, polishers, wash kits & more for that showroom-quality finish at home.',
        cta: 'Shop Car Care',
    ...
    },
    {
        ...
        subtitle: 'Headlights, fog lights, light bars & interior LED kits — plug-and-play installation.',
        cta: 'Shop Lighting',
