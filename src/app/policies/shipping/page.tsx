...
export const metadata: Metadata = { title: 'Shipping Policy', description: 'Shipping Policy for Tech Aabid – delivery times, costs, and shipping information.' };

export default function ShippingPage() {
    return (
        <PolicyLayout title="Shipping Policy" lastUpdated="March 2026">
            <p>At Tech Aabid, we aim to get your orders to you as quickly and affordably as possible. Here is everything you need to know about our shipping practices.</p>
            ...
            <p>If your order arrives damaged, is missing items, or does not arrive within the estimated delivery window, please contact us within 48 hours at support@techaabid.com. We will work with you and the shipping carrier to resolve the issue promptly.</p>
            ...
            <h2>Contact</h2>
            <p>For shipping questions, contact us at support@techaabid.com or call +1 (302) 266-1513.</p>
        </PolicyLayout>
    );
}
