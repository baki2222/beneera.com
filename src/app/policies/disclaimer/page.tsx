...
export const metadata: Metadata = { title: 'Disclaimer', description: 'Disclaimer for Tech Aabid – limitations, product information accuracy, and liability.' };

export default function DisclaimerPage() {
    return (
        <PolicyLayout title="Disclaimer" lastUpdated="March 2026">
            <p>The information provided on this website (techaabid.com) is for general informational purposes only. By using this site, you acknowledge and agree to the following terms.</p>
            ...
            <p>To the maximum extent permitted by applicable law, Tech Aabid and its owners, employees, and affiliates shall not be liable for any direct, indirect, incidental, special, or consequential damages arising from your use of this website or products purchased through it.</p>

            <h2>Product Use</h2>
            <p>Customers are responsible for using products safely and in accordance with any included instructions. Tech Aabid is not liable for injuries, damages, or losses resulting from improper use or modification of any product purchased through our site.</p>

            <h2>Changes</h2>
            <p>We reserve the right to modify this disclaimer at any time. Updates will be posted on this page.</p>

            <h2>Contact</h2>
            <p>Questions about this disclaimer can be directed to support@techaabid.com.</p>
        </PolicyLayout>
    );
}
